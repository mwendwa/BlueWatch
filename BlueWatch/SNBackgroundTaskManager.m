...
@interface SNBackgroundTaskManager()
...
@implementation SNBackgroundTaskManager

+ (instancetype)sharedBackgroundTaskManager
{
    static SNBackgroundTaskManager* sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[SNBackgroundTaskManager alloc] init];
    });
